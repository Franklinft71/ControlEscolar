...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link href="<?php echo APP_URL; ?>/vendor/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
  <!-- FontAwesome -->
  <link rel="stylesheet" href="<?php echo APP_URL; ?>/vendor/fontawesome/css/all.min.css">
  <!-- SweetAlert2 -->
  <link href="<?php echo APP_URL; ?>/vendor/sweetalert2/sweetalert2.css" rel="stylesheet">
  <!-- Select2 -->
  <link href="<?php echo APP_URL; ?>/vendor/select2/dist/css/select2.min.css" rel="stylesheet" />
  <link href="<?php echo APP_URL; ?>/vendor/select2/dist/css/select2-bootstrap-5-theme.min.css" rel="stylesheet" />
  <!-- Custom CSS -->
